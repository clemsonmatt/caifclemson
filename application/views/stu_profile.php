...
$(function(){
	$("#country option[value='<?php echo $profile[0]['home_country']; ?>']").prop("selected",true);
});
$(function(){
	$("#major option[value='<?php echo $profile[0]['area_of_study']; ?>']").prop("selected",true);
});
	...
	<div class="row-fluid">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                        	...
                        	<tr>
                                ...
                                <td><input class="offset2 input-large required" type="text" name="first_name" value="<?php echo $profile[0]['first_name']; ?>" /></td>
                            </tr>
                            <tr>
                            	<td><strong>Last Name (Family Name)</strong></td>
                                <td><input class="offset2 input-large required" type="text" name="last_name" value="<?php echo $profile[0]['last_name']; ?>" /></td>
                            </tr>
                            <tr>
                            	<td><strong>Do you have an American name?</strong></td>
                                <td><input class="offset2 input-large required" type="text" name="american_name" value="<?php echo $profile[0]['american_name']; ?>" /></td>
                            </tr>
                            <tr>
                            	<td><strong>Gender</strong></td>
                                <td>
                                	<select class="offset2 required" name="gender">
                                		<option value="0" <?php if($profile[0]['gender']==0){ echo 'selected="selected"'; } ?>>Male</option>
                                        <option value="1" <?php if($profile[0]['gender']==1){ echo 'selected="selected"'; } ?>>Female</option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                	<select class="offset2 span3" name="month">
                                    	<?php $i=1; foreach($months as $month): ?>
                                        	<option value="<?php echo $month; ?>"<?php if(substr($profile[0]['birthday'],0,-8) == $month){ $month_use = $month; echo 'selected="selected"'; } ?>><?php echo $month; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                    <select class="span3" name="day">
                                    	<?php $i=1; foreach($days as $day): ?>
                                        	<option value="<?php echo $day; ?>"<?php if(substr($profile[0]['birthday'],0,-5) == $month_use."/".$day){ $day_use = $day; echo 'selected="selected"'; } ?>><?php echo $day; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                    <select class="span4" name="year">
                                    	<?php $i=1; foreach($years as $year): ?>
                                        	<option value="<?php echo $year; ?>"<?php if($profile[0]['birthday'] == $month_use."/".$day_use."/".$year){ echo 'selected="selected"'; } ?>><?php echo $year; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td><input class="offset2 input-large required" type="text" name="phone" value="<?php echo $profile[0]['phone']; ?>" /></td>
                            </tr>
                            <tr>
                            	<td><strong>Email</strong></td>
                                <td><input class="offset2 input-large required" type="email" name="email" value="<?php echo $profile[0]['email']; ?>" /></td>
                            </tr>
                            <tr>
                            	<td><strong>Apartment Complex</strong></td>
                                <td><input class="offset2 input-large required" type="text" name="apt_name" value="<?php echo $profile[0]['apartment_complex']; ?>" /></td>
                            </tr>
                            <tr>
                            	<td><strong>Apartment Number</strong></td>
                                <td><input class="offset2 input-large required" type="text" name="apt_num" value="<?php echo $profile[0]['apartment_number']; ?>" /></td>
                            </tr>
                            <tr>
                            	<td><strong>Mailing Address</strong></td>
                                <td><input class="offset2 input-large required" type="text" name="address" value="<?php echo $profile[0]['mailing_address']; ?>" /></td>
                            </tr>
                            <tr>
                            	<td><strong>City</strong></td>
                                <td><input class="offset2 input-large required" type="text" name="city" value="<?php echo $profile[0]['city']; ?>" /></td>
                            </tr>
                            <tr>
                            	<td><strong>Postal/Zip Code</strong></td>
                                <td><input class="offset2 input-large required" type="text" name="zip" value="<?php echo $profile[0]['zip']; ?>" /></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                	<select class="offset2 required" name="degree_program">
                                    	<option value="0" <?php if($profile[0]['degree_program']==0) echo 'selected="selected"'; ?>>Undergraduate</option>
                                        <option value="1" <?php if($profile[0]['degree_program']==1) echo 'selected="selected"'; ?>>Masters</option>
                                        <option value="2" <?php if($profile[0]['degree_program']==2) echo 'selected="selected"'; ?>>PH.D.</option>
                                        <option value="3" <?php if($profile[0]['degree_program']==3) echo 'selected="selected"'; ?>>Post Doc.</option>
                                        <option value="4" <?php if($profile[0]['degree_program']==4) echo 'selected="selected"'; ?>>Visiting Scholar</option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                	<select class="offset2 required" name="marital_status">
                                    	<option value="0" <?php if($profile[0]['marital_status']==0) echo 'selected="selected"'; ?>>Single</option>
                                        <option value="1" <?php if($profile[0]['marital_status']==1) echo 'selected="selected"'; ?>>Married</option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                	<select class="offset2 required" name="spouse_here">
                                    	<option value="0" <?php if($profile[0]['spouse_here']==0) echo 'selected="selected"'; ?>>No</option>
                                        <option value="1" <?php if($profile[0]['spouse_here']==1) echo 'selected="selected"'; ?>>Yes</option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                            	<td><strong>If Married, what is your spouse's name?</strong></td>
                                <td><input class="offset2" type="text" name="spouse_name" value="<?php echo $profile[0]['spouse_name']; ?>" /></td>
                            </tr>
                            <tr>
                            	<td><strong>Do you smoke?</strong></td>
                                <td>
                                	<select class="offset2 required" name="smoke">
                                    	<option value="0" <?php if($profile[0]['smoke']==0) echo 'selected="selected"'; ?>>No</option>
                                        <option value="1" <?php if($profile[0]['smoke']==1) echo 'selected="selected"'; ?>>Yes</option>
                                    </select>
                                </td>
                            </tr>
                             <tr>
                                ...
                                <td>
                                	<select class="offset2 required" name="car">
                                    	<option value="0" <?php if($profile[0]['car']==0) echo 'selected="selected"'; ?>>No</option>
                                        <option value="1" <?php if($profile[0]['car']==1) echo 'selected="selected"'; ?>>Yes</option>
                                    </select>
                                </td>
                            </tr>
                        </tbody>
                    ...
                    <table width="500px">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <textarea class="required span12" rows="8" name="allergies"><?php echo $profile[0]['allergies']; ?></textarea></td>
                            </tr>
                            <tr>
                            	<td><strong>List all foods you do not eat.</strong><br />
                                <textarea class="required span12" rows="8" name="DNE_foods"><?php echo $profile[0]['DNE_foods']; ?></textarea></td>
                            </tr>
                            <tr>
                            	<td><strong>List activities you enjoy.</strong><br />
                                <textarea class="required span12" rows="8" name="activities"><?php echo $profile[0]['activities']; ?></textarea></td>
                            </tr>
                            <tr>
                            	<td><strong>List languages you speak.</strong><br />
                                <textarea class="required span12" rows="8" name="languages"><?php echo $profile[0]['languages']; ?></textarea></td>
                            </tr>
                            <tr>
                            	<td><strong>List places you have traveled.</strong><br />
                                <textarea class="required span12" rows="8" name="travel"><?php echo $profile[0]['travel']; ?></textarea></td>
                            </tr>
                            <tr>
                            	<td><strong>Do you have children?</strong><br />
                                	<input class="offset1" name="kids" type="radio" value="0" <?php if($profile[0]['kids']==0) echo 'checked="checked"';?>> No</input>
                                    <input class="offset1" name="kids" type="radio" value="1" <?php if($profile[0]['kids']==1) echo 'checked="checked"';?>> Yes</input>
                                </td>
                            </tr>
                            <tr><td>&nbsp;</td></tr>
                            <tr>
                            	<td><strong>If yes,are your children in the US with you?</strong><br />
                                	<input class="offset1" name="kids_here" type="radio" value="0" <?php if($profile[0]['kids_here']==0) echo 'checked="checked"';?>> No</input>
                                    <input class="offset1" name="kids_here" type="radio" value="1" <?php if($profile[0]['kids_here']==1) echo 'checked="checked"';?>> Yes</input>
                                </td>
                            </tr>
                            <tr><td>&nbsp;</td></tr>
                            <tr>
        ...
        <div class="span4">
        	...
        	<ul class="nav nav-list">
                <li class="nav-header">Host Info</li>
                <a onclick="alertMsg('<?php echo base_url().'profile/view_host/'.$profile[0]['host_id']; ?>')" href="#"><button class="btn btn-warning">View Host's Info</button></a>
            </ul>
            <?php endif; ?>
            <br />
            <div class="well">
