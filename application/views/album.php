...
<div class="container">
	<div class="row-fluid">
    	<div class="well span8">
        	<h3><?php foreach($albums as $album){ if($album['id']==$album_id){ echo $album['name'].' Album'; } } ?></h3>
            <h5 style="color:rgb(255,85,0);"><?php foreach($albums as $album){ if($album['id']==$album_id){ echo $album['description']; } } ?></h5>
            <table class="table">
            	<thead>
