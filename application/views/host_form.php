...
$(document).ready(function(){     
    $('#username').blur(function(){
		 ...
		 $.ajax({
			 type: "POST",
			 url: base_url+"host/checkUsername",
			 data: form_data,
    	...
    	<div class="well span8">
            ...
            <form action="<?php echo base_url().'host/submit_host'; ?>" method="post" enctype="multipart/form-data">
                                	...
                                	<ul style="list-style:none">
                                        ...
                                        <ul id="hosting" style="display:none; list-style:none;">
                                        	...
                                        	<li>
                                                ...
                                                <input class="offset1" type="radio" name="students" value="Four" /> Four
                                                <input class="offset1" type="radio" name="students" value="Five" /> Five
                                                <input class="offset1" type="radio" name="students" value="Six" /> Six
                ...
                <fieldset>
                    ...
                    <strong>Once your account is completed at the bottom of this form, you may log back in at any time to change these involvement preferences</strong><br /><br />
                	...
                	<table class="table table-striped">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><input id="username" class="span8" type="text" name="username" /><br />
                                	<!--span id="myMessage" class="myMessage span8"></span-->
                                    <!--input type="button" id="button1" value="Check Username" /-->     
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <br /><input class="btn btn-large btn-primary" type="submit" value="Submit Host Friend Form" />
                                </td>
                            </tr>
                        </tbody>
                    </table>
...
function checkUsername()
{
	...
	timer2=setTimeout(function validate(){
		...
		if(yes == 1)
		{
			...
			message.style.color = badColor;
			message.innerHTML = "Username is already in use!"
		}
		else
		{
