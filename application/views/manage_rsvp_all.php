...
<div class="container">
	<div class="row-fluid">
    	<div class="well span8">
        	<a href="<?php echo base_url().'manage/rsvp'; ?>" style="float:right;"><button class="btn">Show Current RSVPs To Events</button></a>
        	...
        	<?php if(isset($events)){ foreach($events as $event): ?>
            	<?php if($event['rsvp'] == 'yes'){ ?>
                    ...
                    <p <?php if(date(strtotime($event['date']))<time()){ echo 'style="color:#F00;"'; } ?>><?php echo 'Event Date: '.date($event['date']); ?></p>
                    <?php } ?>
                    </legend>
