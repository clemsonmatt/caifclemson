...
<div class="container">
	<div class="row-fluid">
    	<div class="well span8">
        	<legend><h4>Add A Recipe</h4></legend>
            <form action="<?php echo base_url().'host/submit_recipe'; ?>" method="post">
            <table class="table table-striped">
                ...
                <tbody>
                	<tr>
                        ...
                        <td><input class="span11" type="text" name="title" /></td>
                    <tr>
                    <tr>
                    	<td><strong>Description</strong></td>
                        <td><textarea class="span11" rows="8" name="description"></textarea></td> 
                    </tr>
                    <tr>
                    	<td><strong>URL</strong></td>
                        <td><input class="span11" type="text" name="url" /></td>
                    </tr>
                    <tr>
                    	<td><strong>Ingredients</strong></td>
                        <td><textarea class="span11" rows="8" name="ingredients"></textarea></td>
                    </tr>
                    <tr>
                    	<td><strong>Instructions</strong></td>
                        <td><textarea class="span11" rows="8" name="instructions"></textarea></td>
                    </tr>
                </tbody>
            </table>
